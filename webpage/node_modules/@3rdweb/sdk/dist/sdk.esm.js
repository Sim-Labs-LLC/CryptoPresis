...
import { ERC20__factory, Forwarder__factory, Coin__factory, ProtocolControl__factory, Royalty__factory, NFTCollection__factory, SignatureMint721__factory, Market__factory, Pack__factory, LazyMintERC721__factory, LazyMintERC1155__factory, DataStore__factory, VotingGovernor__factory, Marketplace__factory, ERC721__factory, LazyNFT__factory, ERC1155__factory, ERC165__factory, NFT__factory, Registry__factory } from '@3rdweb/contracts';
...
var NotEnoughTokensError = /*#__PURE__*/function (_Error6) {
  _inheritsLoose(NotEnoughTokensError, _Error6);

  /** @internal */
  function NotEnoughTokensError(contractAddress, quantity, available) {
    return _Error6.call(this, "BALANCE ERROR: you do not have enough balance on contract " + contractAddress + " to use " + quantity + " tokens. You have " + available + " tokens available.") || this;
  }

  return NotEnoughTokensError;
}( /*#__PURE__*/_wrapNativeSuper(Error));
var MissingOwnerRoleError = /*#__PURE__*/function (_Error7) {
  _inheritsLoose(MissingOwnerRoleError, _Error7);

  /** @internal */
  function MissingOwnerRoleError() {
    return _Error7.call(this, "LIST ERROR: you should be the owner of the token to list it.") || this;
  }

  return MissingOwnerRoleError;
}( /*#__PURE__*/_wrapNativeSuper(Error));
var QuantityAboveLimitError = /*#__PURE__*/function (_Error8) {
  _inheritsLoose(QuantityAboveLimitError, _Error8);

  /** @internal */
  function QuantityAboveLimitError(quantity) {
    return _Error8.call(this, "BUY ERROR: You cannot buy more than " + quantity + " tokens") || this;
  }
...
var FetchError = /*#__PURE__*/function (_Error9) {
  _inheritsLoose(FetchError, _Error9);

  /** @internal */
  function FetchError(message, innerError) {
    var _this;

    _this = _Error9.call(this, "FETCH_FAILED: " + message) || this;
...
var DuplicateLeafsError = /*#__PURE__*/function (_Error10) {
  _inheritsLoose(DuplicateLeafsError, _Error10);

  function DuplicateLeafsError(message) {
    return _Error10.call(this, "DUPLICATE_LEAFS" + (message ? " : " + message : "")) || this;
  }
...
var AuctionAlreadyStartedError = /*#__PURE__*/function (_Error11) {
  _inheritsLoose(AuctionAlreadyStartedError, _Error11);

  function AuctionAlreadyStartedError(id) {
    return _Error11.call(this, "Auction already started with existing bid" + (id ? ", id: " + id : "")) || this;
  }
...
var ListingNotFoundError = /*#__PURE__*/function (_Error12) {
  _inheritsLoose(ListingNotFoundError, _Error12);

  function ListingNotFoundError(marketplaceContractAddress, listingId) {
    return _Error12.call(this, "Could not find listing." + (marketplaceContractAddress ? " marketplace address: " + marketplaceContractAddress : "") + (listingId ? " listing id: " + listingId : "")) || this;
  }
...
var WrongListingTypeError = /*#__PURE__*/function (_Error13) {
  _inheritsLoose(WrongListingTypeError, _Error13);

  function WrongListingTypeError(marketplaceContractAddress, listingId, actualType, expectedType) {
    return _Error13.call(this, "Incorrect listing type. Are you sure you're using the right method?." + (marketplaceContractAddress ? " marketplace address: " + marketplaceContractAddress : "") + (listingId ? " listing id: " + listingId : "") + (expectedType ? " expected type: " + expectedType : "") + (actualType ? " actual type: " + actualType : "")) || this;
  }
...
var RestrictedTransferError = /*#__PURE__*/function (_Error14) {
  _inheritsLoose(RestrictedTransferError, _Error14);

  function RestrictedTransferError(assetAddress) {
    return _Error14.call(this, "Failed to transfer asset, transfer is restricted." + (assetAddress ? " Address : " + assetAddress : "")) || this;
  }
...
var AdminRoleMissingError = /*#__PURE__*/function (_Error15) {
  _inheritsLoose(AdminRoleMissingError, _Error15);
  ...
  function AdminRoleMissingError(address, contractAddress, message) {
    ...
    return _Error15.call(this, message + ", admin role is missing" + (address ? " on address: " + address : "") + (contractAddress ? " on contract: " + contractAddress : "")) || this;
  }
...
var AuctionHasNotEndedError = /*#__PURE__*/function (_Error16) {
  _inheritsLoose(AuctionHasNotEndedError, _Error16);

  function AuctionHasNotEndedError(id, endTime) {
    return _Error16.call(this, "Auction has not ended yet" + (id ? ", id: " + id : "") + (endTime ? ", end time: " + endTime.toString() : "")) || this;
  }
...
var Module = /*#__PURE__*/function () {
  ...
  function () {
    ...
    function sendAndWaitForTransaction(_x10, _x11, _x12, _x13) {
  ...
  function () {
    var _sendGaslessTransaction = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee11(contract, fn, args, callOverrides) {
      ...
      var signer, provider, chainId, from, to, value, data, forwarderAddress, forwarder, gasEstimate, gas, nonce, domain, types, message, signature, spender, amount, permit, txHash;
      return runtime_1.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 38:
              _context11.next = 40;
              return this.signTypedData(signer, from, domain, types, message);
...
var AppModule = /*#__PURE__*/function (_ModuleWithRoles) {
          ...
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              return Promise.all(addresses.map(function (address) {
                return getContractMetadata(_this2.providerOrSigner, address, _this2.ipfsGatewayUrl, true);
              }));
      ...
      return runtime_1.wrap(function _callee24$(_context24) {
        while (1) {
          switch (_context24.prev = _context24.next) {
            ...
            case 15:
              lastTransaction = _context24.sent;
            ...
            case 22:
              treasuryBalance = _context24.sent;
              ...
              royalty = Royalty__factory.connect(treasury, this.readOnlyContract.provider);
            ...
            case 36:
              return _context24.abrupt("return", lastTransaction);
        ...
        while (1) {
          switch (_context27.prev = _context27.next) {
            ...
            case 3:
              ...
              _context27.t2 = BundleModuleMetadata;
            ...
            case 27:
              ...
              return _context27.abrupt("return", this.sdk.getBundleModule(address));
        ...
        while (1) {
          switch (_context28.prev = _context28.next) {
            ...
            case 3:
              ...
              _context28.t2 = SplitsModuleMetadata;
        ...
        while (1) {
          switch (_context29.prev = _context29.next) {
            ...
            case 3:
              ...
              _context29.t2 = NftModuleMetadata;
            ...
            case 14:
              ...
              _context29.t7 = getNativeTokenByChainId;
              _context29.next = 18;
              return this.getChainID();

            case 18:
              _context29.t8 = _context29.sent;
              nativeTokenWrapperAddress = (0, _context29.t7)(_context29.t8).wrapped.address;
              _context29.t9 = this;
              _context29.t10 = ModuleType.NFT;
              _context29.t11 = metadata.name;
              _context29.t12 = metadata.symbol ? metadata.symbol : "";
              _context29.t13 = metadataUri;
              _context29.t14 = this.address;
              _context29.next = 28;
              return this.sdk.getForwarderAddress();

            case 28:
              _context29.t15 = _context29.sent;
              _context29.t16 = nativeTokenWrapperAddress;
              ...
              _context29.t17 = metadata.defaultSaleRecipientAddress;
              _context29.next = 37;
              break;
            ...
            case 37:
              _context29.t18 = _context29.t17;
              _context29.t19 = metadata.sellerFeeBasisPoints;
              _context29.t20 = metadata.primarySaleFeeBasisPoints ? metadata.primarySaleFeeBasisPoints : 0;
              _context29.t21 = [_context29.t11, _context29.t12, _context29.t13, _context29.t14, _context29.t15, _context29.t16, _context29.t18, _context29.t19, _context29.t20];
              _context29.t22 = SignatureMint721__factory;
              _context29.next = 44;
              return _context29.t9._deployModule.call(_context29.t9, _context29.t10, _context29.t21, _context29.t22);
        ...
        while (1) {
          switch (_context30.prev = _context30.next) {
            ...
            case 3:
              ...
              _context30.t2 = CurrencyModuleMetadata;
        ...
        while (1) {
          switch (_context31.prev = _context31.next) {
            ...
            case 3:
              ...
              _context31.t2 = CurrencyModuleMetadata;
        ...
        while (1) {
          switch (_context32.prev = _context32.next) {
            ...
            case 3:
              ...
              _context32.t2 = MarketModuleMetadata;
        ...
        while (1) {
          switch (_context33.prev = _context33.next) {
            ...
            case 3:
              ...
              _context33.t2 = PackModuleMetadata;
        ...
        while (1) {
          switch (_context34.prev = _context34.next) {
            ...
            case 4:
              ...
              _context34.t2 = DropModuleMetadata;
            ...
            case 19:
              ...
              _context34.t9 = this;
              _context34.t10 = ModuleType.DROP;
            ...
            case 29:
              ...
              _context34.t17 = metadata.primarySaleRecipientAddress;
              _context34.t18 = metadata.sellerFeeBasisPoints ? metadata.sellerFeeBasisPoints : 0;
              _context34.t19 = metadata.primarySaleFeeBasisPoints ? metadata.primarySaleFeeBasisPoints : 0;
              _context34.t20 = [_context34.t11, _context34.t12, _context34.t13, _context34.t14, _context34.t15, _context34.t16, _context34.t17, _context34.t18, _context34.t19];
              _context34.t21 = LazyMintERC721__factory;
              _context34.next = 38;
              return _context34.t9._deployModule.call(_context34.t9, _context34.t10, _context34.t20, _context34.t21);
        ...
        while (1) {
          switch (_context35.prev = _context35.next) {
            ...
            case 4:
              ...
              _context35.t2 = DropModuleMetadata;
        ...
        while (1) {
          switch (_context36.prev = _context36.next) {
            ...
            case 3:
              ...
              _context36.t2 = DatastoreModuleMetadata;
        ...
        while (1) {
          switch (_context37.prev = _context37.next) {
            ...
            case 21:
              ...
              _context37.t3 = VoteModuleMetadata;
  ...
  _proto.shouldUpgradeToV2 = /*#__PURE__*/function () {
    var _shouldUpgradeToV = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee38() {
  ...
  _proto.shouldUpgradeModuleList = /*#__PURE__*/function () {
    var _shouldUpgradeModuleList = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee39() {
      var _this4 = this;
      ...
      return runtime_1.wrap(function _callee39$(_context39) {
        while (1) {
          switch (_context39.prev = _context39.next) {
            ...
            case 10:
              _context39.next = 12;
              return this.getAllModuleMetadata([ModuleType.NFT, ModuleType.BUNDLE, ModuleType.PACK, ModuleType.DROP, ModuleType.BUNDLE_DROP]);

            case 12:
              modules = _context39.sent;
              return _context39.abrupt("return", modules.filter(function (m) {
  ...
  _proto.upgradeModuleList = /*#__PURE__*/function () {
    var _upgradeModuleList = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee40(moduleAddresses) {
      var _this5 = this;

      var signer, allUpgradableModules, upgradableModules, moduleMetadatas, royaltyTreasury, metadataUris, nonce, txData, txs;
      return runtime_1.wrap(function _callee40$(_context40) {
        while (1) {
          switch (_context40.prev = _context40.next) {
            case 0:
              signer = this.getSigner();
              !signer ? process.env.NODE_ENV !== "production" ? invariant(false, "needs a signer") : invariant(false) : void 0;
              _context40.next = 4;
              return this.shouldUpgradeModuleList();

            case 4:
              allUpgradableModules = _context40.sent;
              upgradableModules = allUpgradableModules.filter(function (m) {
              ...
              _context40.next = 8;
              return Promise.all(upgradableModules.map(function (m) {
                return _this5.sdk.getNFTModule(m.address).getMetadata(false);
              }));

            case 8:
              moduleMetadatas = _context40.sent;
              _context40.next = 11;
              return this.getRoyaltyTreasury();
            ...
            case 14:
              metadataUris = _context40.sent;
              _context40.next = 17;
              return signer.getTransactionCount("pending");

            case 17:
              nonce = _context40.sent;
    ...
    function upgradeModuleList(_x27) {
  ...
  /*#__PURE__*/
  function () {
    var _upgradeToV = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee41(upgradeOptions) {
        ...
        while (1) {
          switch (_context41.prev = _context41.next) {
            ...
            case 13:
              ...
              _context41.t1 = {
                address: _context41.t0,
                shares: 100
              };
              upgradeOptions.splitsRecipients = [_context41.t1];
            ...
            case 18:
              metadata = _context41.sent.metadata;
              _context41.next = 21;
            ...
            case 21:
              splitsAddress = _context41.sent.address;
  ...
  /*#__PURE__*/
  function () {
    var _balance = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee42() {
      ...
      return runtime_1.wrap(function _callee42$(_context42) {
        while (1) {
          switch (_context42.prev = _context42.next) {
            ...
            case 2:
              projectBalance = _context42.sent;
              treasuryBalance = BigNumber.from(0);
              _context42.next = 6;
              return this.getRoyaltyTreasury();

            case 6:
              treasury = _context42.sent;
            ...
            case 10:
              treasuryBalance = _context42.sent;

            case 11:
              return _context42.abrupt("return", projectBalance.add(treasuryBalance));
  ...
  /*#__PURE__*/
  function () {
    var _balanceOfToken = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee43(tokenAddress) {
      ...
      return runtime_1.wrap(function _callee43$(_context43) {
        while (1) {
          switch (_context43.prev = _context43.next) {
            ...
            case 4:
              balance = _context43.sent;
              _context43.next = 30;
              break;

            case 7:
              erc20 = ERC20__factory.connect(tokenAddress, this.readOnlyContract.provider); // TODO: multicall :)
            ...
            case 28:
              ...
              _context43.t1.add.call(_context43.t1, _context43.t2);
  ...
  /*#__PURE__*/
  function () {
    var _isV1UpgradedOrV = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee45() {
  ...
  _proto.deployMarketplaceModule = /*#__PURE__*/function () {
    var _deployMarketplaceModule = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee46(metadata) {
      var serializedMetadata, metadataUri, nativeTokenWrapperAddress, address;
      return runtime_1.wrap(function _callee46$(_context46) {
        while (1) {
          switch (_context46.prev = _context46.next) {
            case 0:
              _context46.t0 = this.jsonConvert;
              _context46.next = 3;
              return this._prepareMetadata(metadata);

            case 3:
              _context46.t1 = _context46.sent;
              _context46.t2 = MarketplaceModuleMetadata$1;
              serializedMetadata = _context46.t0.serializeObject.call(_context46.t0, _context46.t1, _context46.t2);
              _context46.t3 = this.sdk.getStorage();
              _context46.t4 = serializedMetadata;
              _context46.t5 = this.address;
              _context46.next = 11;
              return this.getSignerAddress();
            ...
            case 11:
              ...
              _context46.next = 14;
              return _context46.t3.uploadMetadata.call(_context46.t3, _context46.t4, _context46.t5, _context46.t6);

            case 14:
              metadataUri = _context46.sent;
              _context46.t7 = getNativeTokenByChainId;
              _context46.next = 18;
              return this.getChainID();

            case 18:
              _context46.t8 = _context46.sent;
              nativeTokenWrapperAddress = (0, _context46.t7)(_context46.t8).wrapped.address;
              _context46.t9 = this;
              _context46.t10 = ModuleType.MARKETPLACE;
              _context46.t11 = this.address;
              _context46.next = 25;
              return this.sdk.getForwarderAddress();

            case 25:
              _context46.t12 = _context46.sent;
              _context46.t13 = nativeTokenWrapperAddress;
              _context46.t14 = metadataUri;
              _context46.t15 = metadata.marketFeeBasisPoints;
              _context46.t16 = [_context46.t11, _context46.t12, _context46.t13, _context46.t14, _context46.t15];
              _context46.t17 = Marketplace__factory;
              _context46.next = 33;
              return _context46.t9._deployModule.call(_context46.t9, _context46.t10, _context46.t16, _context46.t17);

            case 33:
              address = _context46.sent;
              return _context46.abrupt("return", this.sdk.getMarketplaceModule(address));
    ...
    function deployMarketplaceModule(_x30) {
...
var BundleModule = /*#__PURE__*/function (_ModuleWithRoles) {
  ...
  _proto.createAndMintBatch = /*#__PURE__*/function () {
    var _createAndMintBatch = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee11(metadataWithSupply) {
      ...
      var metadatas, baseUri, uris, supplies, to, receipt, event, tokenIds;
      return runtime_1.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
          ...
          switch (_context31.prev = _context31.next) {
            ...
            case 13:
              ...
              return Promise.all(ownedBalances.map( /*#__PURE__*/function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee30(b) {
                  return runtime_1.wrap(function _callee30$(_context30) {
                    while (1) {
                      switch (_context30.prev = _context30.next) {
                        case 0:
...
var ClaimConditionFactory = /*#__PURE__*/function () {
  ...
  _proto.buildConditionsForDropV1 = function buildConditionsForDropV1() {
...
var BundleDropModule = /*#__PURE__*/function (_ModuleWithRoles) {
  ...
  _proto.updateClaimConditions = /*#__PURE__*/function () {
    var _updateClaimConditions = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee21(tokenId, factory) {
      var conditions, merkleInfo, _yield$this$getMetada2, metadata, metadataUri, encoded;
        ...
        while (1) {
          switch (_context21.prev = _context21.next) {
            ...
            case 11:
              ...
              encoded = [this.contract["interface"].encodeFunctionData("setContractURI", [metadataUri]), this.contract["interface"].encodeFunctionData("updateClaimConditions", [tokenId, conditions])];
              _context21.next = 15;
              return this.sendTransaction("multicall", [encoded]);
  ...
  _proto.claim = /*#__PURE__*/function () {
    var _claim = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee23(tokenId, quantity, proofs) {
  ...
  _proto.burn = /*#__PURE__*/function () {
    var _burn = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee24(tokenId, amount) {
      var account;
      return runtime_1.wrap(function _callee24$(_context24) {
        while (1) {
          switch (_context24.prev = _context24.next) {
  ...
  _proto.transferFrom = /*#__PURE__*/function () {
    var _transferFrom = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee25(from, to, tokenId, amount, data) {
      return runtime_1.wrap(function _callee25$(_context25) {
        while (1) {
          switch (_context25.prev = _context25.next) {
            case 0:
    ...
    function transferFrom(_x36, _x37, _x38, _x39, _x40) {
      return _transferFrom.apply(this, arguments);
    }
  ...
  function () {
    ...
    function setModuleMetadata(_x41) {
      return _setModuleMetadata.apply(this, arguments);
    }
      ...
      return runtime_1.wrap(function _callee27$(_context27) {
        while (1) {
          switch (_context27.prev = _context27.next) {
            ...
            case 2:
              _yield$this$getMetada4 = _context27.sent;
            ...
            case 7:
              metadata.seller_fee_basis_points = amount;
              _context27.t0 = this.sdk.getStorage();
              _context27.t1 = _extends({}, metadata);
            ...
            case 13:
              ...
              _context27.next = 16;
              return _context27.t0.uploadMetadata.call(_context27.t0, _context27.t1, _context27.t2, _context27.t3);
  ...
  /*#__PURE__*/
  function () {
    var _getRoyaltyBps = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee28() {
      return runtime_1.wrap(function _callee28$(_context28) {
        while (1) {
          switch (_context28.prev = _context28.next) {
            case 0:
  ...
  /*#__PURE__*/
  function () {
    var _getRoyaltyRecipientAddress = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee29() {
      var _metadata$metadata;
        ...
        while (1) {
          switch (_context29.prev = _context29.next) {
            ...
            case 2:
              ...
              return _context29.abrupt("return", metadata.metadata.fee_recipient);
  ...
  /*#__PURE__*/
  function () {
    var _totalSupply = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee30(tokenId) {
      return runtime_1.wrap(function _callee30$(_context30) {
        while (1) {
          switch (_context30.prev = _context30.next) {
            case 0:
  ...
  /*#__PURE__*/
  function () {
    var _getAllClaimerAddresses = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee31(tokenId) {
      var a;
      return runtime_1.wrap(function _callee31$(_context31) {
        while (1) {
          switch (_context31.prev = _context31.next) {
            ...
            case 2:
              a = _context31.sent;
              return _context31.abrupt("return", Array.from(new Set(a.map(function (b) {
    ...
    function getAllClaimerAddresses(_x44) {
  ...
  /*#__PURE__*/
  function () {
    var _getClaimIneligibilityReasons = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee32(tokenId, quantity, addressToCheck) {
      var reasons, activeConditionIndex, claimCondition, _yield$Promise$all2, merkleRootArray, merkleLower, proofs, hashedAddress, timestampForNextClaim, now, totalPrice, provider, balance, _provider, _balance2;
      ...
      return runtime_1.wrap(function _callee32$(_context32) {
        while (1) {
          switch (_context32.prev = _context32.next) {
            ...
            case 6:
              _yield$Promise$all2 = _context32.sent;
            ...
            case 11:
              ...
              if (!_context32.t0.message.includes("no public mint condition.")) {
                _context32.next = 16;
                break;
              }

              reasons.push(ClaimEligibility.NoActiveClaimPhase);
              return _context32.abrupt("return", reasons);

            case 16:
              console.error("Failed to get active claim condition", _context32.t0);
            ...
            case 28:
              timestampForNextClaim = _context32.sent;
    ...
    function getClaimIneligibilityReasons(_x45, _x46, _x47) {
  ...
  /*#__PURE__*/
  function () {
    var _canClaim = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee33(tokenId, quantity, addressToCheck) {
      return runtime_1.wrap(function _callee33$(_context33) {
        while (1) {
          switch (_context33.prev = _context33.next) {
            case 0:
            ...
            case 3:
              addressToCheck = _context33.sent;
            ...
            case 6:
              _context33.t0 = _context33.sent.length;
              return _context33.abrupt("return", _context33.t0 === 0);
    ...
    function canClaim(_x48, _x49, _x50) {
  ...
  /*#__PURE__*/
  function () {
    var _getClaimerProofs = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee34(merkleRoot, addressToClaim) {
      ...
      return runtime_1.wrap(function _callee34$(_context34) {
        while (1) {
          switch (_context34.prev = _context34.next) {
            ...
            case 3:
              addressToClaim = _context34.sent;
            ...
            case 6:
              _yield$this$getMetada5 = _context34.sent;
            ...
            case 16:
              return _context34.abrupt("return", item.proof);
    ...
    function getClaimerProofs(_x51, _x52) {
  ...
  _proto.isTransferRestricted = /*#__PURE__*/function () {
    var _isTransferRestricted = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee35() {
      return runtime_1.wrap(function _callee35$(_context35) {
        while (1) {
          switch (_context35.prev = _context35.next) {
            case 0:
              return _context35.abrupt("return", this.readOnlyContract.transfersRestricted());
  ...
  _proto.setRestrictedTransfer = /*#__PURE__*/function () {
    var _setRestrictedTransfer = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee36(restricted) {
      return runtime_1.wrap(function _callee36$(_context36) {
        while (1) {
          switch (_context36.prev = _context36.next) {
            case 0:
            ...
            case 5:
              ...
              _context36.next = 8;
              return _context36.t0.onlyRoles.call(_context36.t0, _context36.t1, _context36.t2);
    ...
    function setRestrictedTransfer(_x53) {
      return _setRestrictedTransfer.apply(this, arguments);
    }
...
var DropModule = /*#__PURE__*/function (_ModuleWithRoles) {
        ...
        while (1) {
          switch (_context27.prev = _context27.next) {
            ...
            case 15:
              ...
              encoded = [this.contract["interface"].encodeFunctionData("setContractURI", [metatdataUri]), this.contract["interface"].encodeFunctionData("setClaimConditions", [conditions])];
              _context27.next = 19;
              return this.sendTransaction("multicall", [encoded]);
  ...
  _proto.updateClaimConditions = /*#__PURE__*/function () {
    var _updateClaimConditions = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee28(factory) {
      var conditions, merkleInfo, _yield$this$getMetada2, metadata, metatdataUri, encoded;
      ...
      return runtime_1.wrap(function _callee28$(_context28) {
        while (1) {
          switch (_context28.prev = _context28.next) {
            ...
            case 15:
              metatdataUri = _context28.sent;
              encoded = [this.contract["interface"].encodeFunctionData("setContractURI", [metatdataUri]), this.contract["interface"].encodeFunctionData("updateClaimConditions", [conditions])];
              _context28.next = 19;
              return this.sendTransaction("multicall", [encoded]);
  ...
  function () {
    var _getClaimIneligibilityReasons = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee30(quantity, addressToCheck) {
      var reasons, activeConditionIndex, claimCondition, _yield$Promise$all2, merkleRootArray, proofs, timestampForNextClaim, now, totalPrice, provider, balance, _provider, _balance2;
        ...
        while (1) {
          switch (_context30.prev = _context30.next) {
            ...
            case 18:
              ...
              _context30.next = 23;
              return this.getClaimerProofs(claimCondition.merkleRoot.toString(), addressToCheck);
  ...
  _proto.claim = /*#__PURE__*/function () {
    var _claim = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee33(quantity, proofs) {
      var _this7 = this;

      var mintCondition, _yield$this$getMetada3, metadata, addressToClaim, snapshot, jsonConvert, snapshotData, item, overrides, erc20, owner, spender, allowance, totalPrice, receipt, event, startingIndex, endingIndex, tokenIds, i;
        ...
        while (1) {
          switch (_context33.prev = _context33.next) {
            ...
            case 3:
              ...
              return _context33.abrupt("return", this.v1Module.claim(quantity, proofs));
            ...
            case 50:
              ...
              return Promise.all(tokenIds.map( /*#__PURE__*/function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee32(t) {
                  return runtime_1.wrap(function _callee32$(_context32) {
                    while (1) {
                      switch (_context32.prev = _context32.next) {
                        case 0:
  ...
  _proto.burn = /*#__PURE__*/function () {
    var _burn = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee34(tokenId) {
      return runtime_1.wrap(function _callee34$(_context34) {
        while (1) {
          switch (_context34.prev = _context34.next) {
            case 0:
  ...
  _proto.transferFrom = /*#__PURE__*/function () {
    var _transferFrom = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee35(from, to, tokenId) {
      return runtime_1.wrap(function _callee35$(_context35) {
        while (1) {
          switch (_context35.prev = _context35.next) {
            case 0:
    ...
    function transferFrom(_x31, _x32, _x33) {
      return _transferFrom.apply(this, arguments);
    }
  ...
  /*#__PURE__*/
  function () {
    var _setModuleMetadata = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee36(metadata) {
      var uri;
      return runtime_1.wrap(function _callee36$(_context36) {
        while (1) {
          switch (_context36.prev = _context36.next) {
    ...
    function setModuleMetadata(_x34) {
      return _setModuleMetadata.apply(this, arguments);
    }
  ...
  _proto.setRoyaltyBps = /*#__PURE__*/function () {
    var _setRoyaltyBps = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee37(amount) {
      var _yield$this$getMetada4, metadata, encoded, uri;
      ...
      return runtime_1.wrap(function _callee37$(_context37) {
        while (1) {
          switch (_context37.prev = _context37.next) {
            ...
            case 2:
              _yield$this$getMetada4 = _context37.sent;
              metadata = _yield$this$getMetada4.metadata;
              encoded = [];
            ...
            case 7:
              metadata.seller_fee_basis_points = amount;
              _context37.t0 = this.sdk.getStorage();
              _context37.t1 = _extends({}, metadata);
              _context37.t2 = this.address;
              _context37.next = 13;
              return this.getSignerAddress();
            ...
            case 13:
              ...
              _context37.next = 16;
              return _context37.t0.uploadMetadata.call(_context37.t0, _context37.t1, _context37.t2, _context37.t3);
  ...
  /*#__PURE__*/
  function () {
    var _getRoyaltyBps = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee38() {
      return runtime_1.wrap(function _callee38$(_context38) {
        while (1) {
          switch (_context38.prev = _context38.next) {
            case 0:
  ...
  /*#__PURE__*/
  function () {
    var _getRoyaltyRecipientAddress = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee39() {
      var _metadata$metadata;
        ...
        while (1) {
          switch (_context39.prev = _context39.next) {
            ...
            case 2:
              ...
              return _context39.abrupt("return", metadata.metadata.fee_recipient);
  ...
  /*#__PURE__*/
  function () {
    var _createBatch = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee40(metadatas) {
      var startFileNumber, baseUri, receipt, event, startingIndex, endingIndex, tokenIds, i;
      return runtime_1.wrap(function _callee40$(_context40) {
        while (1) {
          switch (_context40.prev = _context40.next) {
            ...
            case 2:
              ...
              return _context40.abrupt("return", this.v1Module.createBatch(metadatas));
            ...
            case 6:
              startFileNumber = _context40.sent;
              _context40.next = 9;
              return this.sdk.getStorage().uploadMetadataBatch(metadatas, this.address, startFileNumber.toNumber());

            case 9:
              baseUri = _context40.sent;
              _context40.next = 12;
              return this.sendTransaction("lazyMint", [metadatas.length, baseUri]);
            ...
            case 12:
              ...
              return _context40.abrupt("return", tokenIds);
  ...
  /*#__PURE__*/
  function () {
    var _canCreateBatch = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee41() {
      return runtime_1.wrap(function _callee41$(_context41) {
        while (1) {
          switch (_context41.prev = _context41.next) {
            case 0:
            ...
            case 2:
              ...
              return _context41.abrupt("return", this.v1Module.canCreateBatch());
  ...
  /*#__PURE__*/
  function () {
    var _isV = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee42() {
      return runtime_1.wrap(function _callee42$(_context42) {
        while (1) {
          switch (_context42.prev = _context42.next) {
            case 0:
            ...
            case 11:
              return _context42.abrupt("return", this._isV1);
  ...
  /*#__PURE__*/
  function () {
    var _getClaimerProofs = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee43(merkleRoot, addressToClaim) {
      var _yield$this$getMetada5, metadata, snapshot, jsonConvert, snapshotData, item;
      ...
      return runtime_1.wrap(function _callee43$(_context43) {
        while (1) {
          switch (_context43.prev = _context43.next) {
            ...
            case 3:
              addressToClaim = _context43.sent;
            ...
            case 6:
              _yield$this$getMetada5 = _context43.sent;
              metadata = _yield$this$getMetada5.metadata;
              _context43.next = 10;
              return this.sdk.getStorage().get(metadata == null ? void 0 : metadata.merkle[merkleRoot]);

            case 10:
              snapshot = _context43.sent;
              jsonConvert = new JsonConvert();
              snapshotData = jsonConvert.deserializeObject(JSON.parse(snapshot), Snapshot);
              item = snapshotData.claims.find(function (c) {
                return c.address === addressToClaim;
            ...
            case 16:
              return _context43.abrupt("return", item.proof);
    ...
    function getClaimerProofs(_x37, _x38) {
      return _getClaimerProofs.apply(this, arguments);
    }
  ...
  _proto.isTransferRestricted = /*#__PURE__*/function () {
    var _isTransferRestricted = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee44() {
      return runtime_1.wrap(function _callee44$(_context44) {
        while (1) {
          switch (_context44.prev = _context44.next) {
            case 0:
              return _context44.abrupt("return", this.readOnlyContract.transfersRestricted());
  ...
  _proto.setRestrictedTransfer = /*#__PURE__*/function () {
    var _setRestrictedTransfer = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee45(restricted) {
      return runtime_1.wrap(function _callee45$(_context45) {
        while (1) {
          switch (_context45.prev = _context45.next) {
            case 0:
            ...
            case 5:
              ...
              _context45.next = 8;
              return _context45.t0.onlyRoles.call(_context45.t0, _context45.t1, _context45.t2);
    ...
    function setRestrictedTransfer(_x39) {
      return _setRestrictedTransfer.apply(this, arguments);
    }
...
var DropV1Module = /*#__PURE__*/function (_ModuleWithRoles2) {
  ...
  _proto2.getTokenMetadata = /*#__PURE__*/function () {
    var _getTokenMetadata3 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee46(tokenId) {
      return runtime_1.wrap(function _callee46$(_context46) {
        while (1) {
          switch (_context46.prev = _context46.next) {
            case 0:
    ...
    function getTokenMetadata$1(_x40) {
  ...
  _proto2.get = /*#__PURE__*/function () {
    var _get2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee47(tokenId) {
  ...
  _proto2.getAll = /*#__PURE__*/function () {
    var _getAll2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee48(queryParams) {
      var _this9 = this;
      ...
      return runtime_1.wrap(function _callee48$(_context48) {
        while (1) {
          switch (_context48.prev = _context48.next) {
            ...
            case 5:
              _context48.t1 = _context48.sent.toNumber();
              _context48.t2 = start + count;
              maxId = _context48.t0.min.call(_context48.t0, _context48.t1, _context48.t2);
              _context48.next = 10;
              return Promise.all(Array.from(Array(maxId - start).keys()).map(function (i) {
  ...
  _proto2.getAllUnclaimed = /*#__PURE__*/function () {
    var _getAllUnclaimed2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee49(queryParams) {
      var _this10 = this;
        ...
        while (1) {
          switch (_context49.prev = _context49.next) {
            case 0:
              start = BigNumber.from((queryParams == null ? void 0 : queryParams.start) || 0).toNumber();
              count = BigNumber.from((queryParams == null ? void 0 : queryParams.count) || DEFAULT_QUERY_ALL_COUNT).toNumber();
              _context49.t0 = BigNumber;
              _context49.t1 = Math;
              _context49.next = 6;
              return this.readOnlyContract.nextTokenId();

            case 6:
              _context49.t2 = _context49.sent.toNumber();
              _context49.t3 = start + count;
              _context49.t4 = _context49.t1.min.call(_context49.t1, _context49.t2, _context49.t3);
              maxId = _context49.t0.from.call(_context49.t0, _context49.t4);
              _context49.next = 12;
              return this.readOnlyContract.nextMintTokenId();

            case 12:
              unmintedId = _context49.sent;
              _context49.next = 15;
              return Promise.all(Array.from(Array(maxId.sub(unmintedId).toNumber()).keys()).map(function (i) {
            ...
            case 15:
              return _context49.abrupt("return", _context49.sent.map(function (metadata) {
                return {
                  owner: AddressZero,
                  metadata: metadata
                };
  ...
  _proto2.getAllClaimed = /*#__PURE__*/function () {
    var _getAllClaimed2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee50(queryParams) {
      var _this11 = this;
  ...
  _proto2.ownerOf = /*#__PURE__*/function () {
    var _ownerOf2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee51(tokenId) {
  ...
  _proto2.getOwned = /*#__PURE__*/function () {
    var _getOwned2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee52(_address) {
      var _this12 = this;
      ...
      return runtime_1.wrap(function _callee52$(_context52) {
        while (1) {
          switch (_context52.prev = _context52.next) {
            ...
            case 7:
              address = _context52.t0;
              _context52.next = 10;
              return this.readOnlyContract.balanceOf(address);

            case 10:
              balance = _context52.sent;
              indices = Array.from(Array(balance.toNumber()).keys());
              _context52.next = 14;
              return Promise.all(indices.map(function (i) {
  ...
  _proto2.transformResultToClaimCondition = /*#__PURE__*/function () {
    var _transformResultToClaimCondition2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee53(pm) {
      var cv;
    ...
    function transformResultToClaimCondition(_x47) {
  ...
  /*#__PURE__*/
  function () {
    var _getActiveMintCondition2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee54() {
      var index;
  ...
  _proto2.getActiveClaimCondition = /*#__PURE__*/function () {
    var _getActiveClaimCondition2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee55() {
      var index, mc;
  ...
  /*#__PURE__*/
  function () {
    var _getAllMintConditions2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee56() {
      var conditions, i;
      return runtime_1.wrap(function _callee56$(_context56) {
        while (1) {
          switch (_context56.prev = _context56.next) {
            ...
            case 10:
              _context56.prev = 10;
              _context56.t2 = _context56["catch"](2);
              return _context56.abrupt("break", 16);
            ...
            case 16:
              return _context56.abrupt("return", conditions);
  ...
  _proto2.getAllClaimConditions = /*#__PURE__*/function () {
    var _getAllClaimConditions2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee57() {
      var conditions, i, mc;
      return runtime_1.wrap(function _callee57$(_context57) {
        while (1) {
          switch (_context57.prev = _context57.next) {
            ...
            case 13:
              _context57.prev = 13;
              _context57.t2 = _context57["catch"](2);
              return _context57.abrupt("break", 19);
            ...
            case 19:
              return _context57.abrupt("return", conditions);
  ...
  _proto2.totalSupply = /*#__PURE__*/function () {
    var _totalSupply2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee58() {
  ...
  _proto2.maxTotalSupply = /*#__PURE__*/function () {
    var _maxTotalSupply2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee59() {
  ...
  _proto2.totalUnclaimedSupply = /*#__PURE__*/function () {
    var _totalUnclaimedSupply2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee60() {
        ...
        while (1) {
          switch (_context60.prev = _context60.next) {
            ...
            case 5:
              ...
              return _context60.abrupt("return", _context60.t0.sub.call(_context60.t0, _context60.t1));
  ...
  _proto2.totalClaimedSupply = /*#__PURE__*/function () {
    var _totalClaimedSupply2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee61() {
  ...
  _proto2.balanceOf = /*#__PURE__*/function () {
    var _balanceOf2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee62(address) {
  ...
  _proto2.balance = /*#__PURE__*/function () {
    var _balance3 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee63() {
        ...
        while (1) {
          switch (_context63.prev = _context63.next) {
            ...
            case 3:
              ...
              _context63.next = 6;
              return _context63.t0.balanceOf.call(_context63.t0, _context63.t1);
    ...
    function balance() {
      return _balance3.apply(this, arguments);
    }
  ...
  _proto2.isApproved = /*#__PURE__*/function () {
    var _isApproved2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee64(address, operator) {
  ...
  /*#__PURE__*/
  function () {
    var _setApproval2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee65(operator, approved) {
    ...
    function setApproval(_x51, _x52) {
  ...
  _proto2.transfer = /*#__PURE__*/function () {
    var _transfer2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee66(to, tokenId) {
      var from;
  ...
  /*#__PURE__*/
  function () {
    var _lazyMint2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee67(metadata) {
  ...
  _proto2.pinToIpfs = /*#__PURE__*/function () {
    var _pinToIpfs = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee68(files) {
  ...
  /*#__PURE__*/
  function () {
    var _lazyMintBatch2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee69(metadatas) {
      var baseUri, uris;
  ...
  /*#__PURE__*/
  function () {
    var _lazyMintAmount = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee70(amount) {
  ...
  /*#__PURE__*/
  function () {
    var _setMintConditions2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee71(factory) {
      return runtime_1.wrap(function _callee71$(_context71) {
        while (1) {
          switch (_context71.prev = _context71.next) {
            case 0:
              return _context71.abrupt("return", this.setClaimConditions(factory));
    ...
    function setMintConditions(_x59) {
  ...
  /*#__PURE__*/
  function () {
    var _setClaimConditions2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee72(factory) {
      ...
      return runtime_1.wrap(function _callee72$(_context72) {
        while (1) {
          switch (_context72.prev = _context72.next) {
            case 0:
              conditions = factory.buildConditionsForDropV1();
              merkleInfo = {};
              factory.allSnapshots().forEach(function (s) {
                merkleInfo[s.merkleRoot] = s.snapshotUri;
              });
            ...
            case 5:
              _yield$this$getMetada6 = _context72.sent;
    ...
    function setClaimConditions(_x60) {
  ...
  /*#__PURE__*/
  function () {
    var _setPublicMintConditions2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee73(conditions) {
      var _conditions;
    ...
    function setPublicMintConditions(_x61) {
  ...
  _proto2.canClaim = /*#__PURE__*/function () {
    var _canClaim2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee74(quantity, proofs) {
      ...
      return runtime_1.wrap(function _callee74$(_context74) {
        while (1) {
          switch (_context74.prev = _context74.next) {
            ...
            case 10:
              overrides = _context74.t0;
              _context74.next = 13;
              return this.getSignerAddress();

            case 13:
              owner = _context74.sent;
  ...
  /*#__PURE__*/
  function () {
    var _getClaimerProofs2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee75(merkleRoot, addressToClaim) {
      ...
      return runtime_1.wrap(function _callee75$(_context75) {
        while (1) {
          switch (_context75.prev = _context75.next) {
            ...
            case 3:
              addressToClaim = _context75.sent;
            ...
            case 6:
              _yield$this$getMetada7 = _context75.sent;
            ...
            case 16:
              return _context75.abrupt("return", item.proof);
    ...
    function getClaimerProofs(_x64, _x65) {
  ...
  _proto2.claim = /*#__PURE__*/function () {
    var _claim2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee77(quantity, proofs) {
      var _this13 = this;
      ...
      return runtime_1.wrap(function _callee77$(_context77) {
        while (1) {
          switch (_context77.prev = _context77.next) {
            ...
            case 3:
              mintCondition = _context77.sent;
              _context77.next = 6;
              return this.getMetadata();

            case 6:
              _yield$this$getMetada8 = _context77.sent;
            ...
            case 35:
              owner = _context77.sent;
              spender = this.address;
              _context77.next = 39;
              return erc20.allowance(owner, spender);

            case 39:
              allowance = _context77.sent;
              totalPrice = BigNumber.from(mintCondition.pricePerToken).mul(BigNumber.from(quantity));
            ...
            case 46:
              ...
              _context77.next = 54;
              return Promise.all(tokenIds.map( /*#__PURE__*/function () {
                var _ref2 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee76(t) {
  ...
  _proto2.burn = /*#__PURE__*/function () {
    var _burn2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee78(tokenId) {
  ...
  _proto2.transferFrom = /*#__PURE__*/function () {
    var _transferFrom2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee79(from, to, tokenId) {
    ...
    function transferFrom(_x70, _x71, _x72) {
  ...
  /*#__PURE__*/
  function () {
    var _setModuleMetadata2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee80(metadata) {
      var uri;
    ...
    function setModuleMetadata(_x73) {
  ...
  _proto2.setRoyaltyBps = /*#__PURE__*/function () {
    var _setRoyaltyBps2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee81(amount) {
      ...
      return runtime_1.wrap(function _callee81$(_context81) {
        while (1) {
          switch (_context81.prev = _context81.next) {
            ...
            case 2:
              _yield$this$getMetada9 = _context81.sent;
            ...
            case 7:
              metadata.seller_fee_basis_points = amount;
              _context81.t0 = this.storage;
              _context81.t1 = _extends({}, metadata);
              _context81.t2 = this.address;
              _context81.next = 13;
              return this.getSignerAddress();
            ...
            case 13:
              ...
              _context81.next = 16;
              return _context81.t0.uploadMetadata.call(_context81.t0, _context81.t1, _context81.t2, _context81.t3);
  ...
  _proto2.setBaseTokenUri = /*#__PURE__*/function () {
    var _setBaseTokenUri = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee82(uri) {
  ...
  _proto2.setMaxTotalSupply = /*#__PURE__*/function () {
    var _setMaxTotalSupply = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee83(amount) {
    ...
    function setMaxTotalSupply(_x76) {
  ...
  /*#__PURE__*/
  function () {
    var _getRoyaltyBps2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee84() {
  ...
  /*#__PURE__*/
  function () {
    var _getRoyaltyRecipientAddress2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee85() {
        ...
        while (1) {
          switch (_context85.prev = _context85.next) {
            ...
            case 2:
              ...
              return _context85.abrupt("return", metadata.metadata.fee_recipient);
  ...
  /*#__PURE__*/
  function () {
    var _createBatch2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee86(metadatas) {
      var startFileNumber, baseUri, encoded;
  ...
  /*#__PURE__*/
  function () {
    var _canCreateBatch2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee87() {
      return runtime_1.wrap(function _callee87$(_context87) {
        while (1) {
          switch (_context87.prev = _context87.next) {
            ...
            case 2:
              return _context87.abrupt("return", _context87.sent.eq(0));
  ...
  _proto2.isTransferRestricted = /*#__PURE__*/function () {
    var _isTransferRestricted2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee88() {
      return runtime_1.wrap(function _callee88$(_context88) {
        while (1) {
          switch (_context88.prev = _context88.next) {
            case 0:
              return _context88.abrupt("return", this.readOnlyContract.transfersRestricted());
  ...
  _proto2.setRestrictedTransfer = /*#__PURE__*/function () {
    var _setRestrictedTransfer2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee89(restricted) {
        ...
        while (1) {
          switch (_context89.prev = _context89.next) {
            ...
            case 5:
              ...
              _context89.next = 8;
              return _context89.t0.onlyRoles.call(_context89.t0, _context89.t1, _context89.t2);
    ...
    function setRestrictedTransfer(_x78) {
...
var MarketplaceModule = /*#__PURE__*/function (_ModuleWithRoles) {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              return _context6.abrupt("return", buffer.gt(bidBuffer));
  ...
  _proto.getDirectListing = /*#__PURE__*/function () {
    var _getDirectListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7(listingId) {
      var listing;
      return runtime_1.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
    ...
    function getDirectListing(_x11) {
  ...
  _proto.getAuctionListing = /*#__PURE__*/function () {
    var _getAuctionListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee8(listingId) {
      var listing;
      return runtime_1.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
    ...
    function getAuctionListing(_x12) {
  ...
  /*#__PURE__*/
  function () {
    var _mapDirectListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee9(listing) {
      return runtime_1.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              _context9.t0 = listing.assetContract;
              _context9.t1 = listing.buyoutPricePerToken;
              _context9.t2 = listing.currency;
              _context9.next = 5;
              return getCurrencyValue(this.providerOrSigner, listing.currency, listing.buyoutPricePerToken);

            case 5:
              _context9.t3 = _context9.sent;
              _context9.t4 = listing.listingId.toString();
              _context9.t5 = listing.tokenId;
              _context9.t6 = listing.quantity;
              _context9.t7 = listing.startTime;
              _context9.next = 12;
            ...
            case 12:
              ...
              _context9.t9 = listing.endTime;
              _context9.t10 = listing.tokenOwner;
              _context9.t11 = ListingType.Direct;
              return _context9.abrupt("return", {
                assetContractAddress: _context9.t0,
                buyoutPrice: _context9.t1,
                currencyContractAddress: _context9.t2,
                buyoutCurrencyValuePerToken: _context9.t3,
                id: _context9.t4,
                tokenId: _context9.t5,
                quantity: _context9.t6,
                startTimeInSeconds: _context9.t7,
                asset: _context9.t8,
                secondsUntilEnd: _context9.t9,
                sellerAddress: _context9.t10,
                type: _context9.t11
              });
    ...
    function mapDirectListing(_x13) {
  ...
  /*#__PURE__*/
  function () {
    var _mapAuctionListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee10(listing) {
      return runtime_1.wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
            ...
            case 15:
              ...
              _context10.t10 = listing.reservePricePerToken;
              _context10.t11 = listing.endTime;
              _context10.t12 = listing.tokenOwner;
              _context10.t13 = ListingType.Auction;
              return _context10.abrupt("return", {
                ...
                startTimeInEpochSeconds: _context10.t7,
                asset: _context10.t8,
                reservePriceCurrencyValuePerToken: _context10.t9,
                reservePrice: _context10.t10,
                endTimeInEpochSeconds: _context10.t11,
                sellerAddress: _context10.t12,
                type: _context10.t13
              });
    ...
    function mapAuctionListing(_x14) {
  ...
  _proto.handleTokenApproval = /*#__PURE__*/function () {
    var _handleTokenApproval = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee11(assetContract, tokenId, from) {
      ...
      return runtime_1.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 12:
              _context11.t0 = _context11.sent.toLowerCase();
              _context11.t1 = this.address.toLowerCase();
              isTokenApproved = _context11.t0 === _context11.t1;
    ...
    function handleTokenApproval(_x15, _x16, _x17) {
  ...
  /*#__PURE__*/
  function () {
    var _validateDirectListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee12(listingId) {
      return runtime_1.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            case 0:
    ...
    function validateDirectListing(_x18) {
  ...
  /*#__PURE__*/
  function () {
    var _validateAuctionListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee13(listingId) {
      return runtime_1.wrap(function _callee13$(_context13) {
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
    ...
    function validateAuctionListing(_x19) {
  ...
  /*#__PURE__*/
  function () {
    var _mapOffer = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee14(listingId, offer) {
      return runtime_1.wrap(function _callee14$(_context14) {
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              _context14.t0 = offer.quantityDesired;
              _context14.t1 = offer.pricePerToken;
              _context14.t2 = offer.currency;
              _context14.t3 = offer.offeror;
              _context14.t4 = offer.quantityWanted;
              _context14.next = 7;
            ...
            case 7:
              ...
              _context14.t6 = listingId;
              return _context14.abrupt("return", {
                quantity: _context14.t0,
                pricePerToken: _context14.t1,
                currencyContractAddress: _context14.t2,
                buyerAddress: _context14.t3,
                quantityDesired: _context14.t4,
                currencyValue: _context14.t5,
                listingId: _context14.t6
              });
  ...
  _proto.getActiveOffer = /*#__PURE__*/function () {
    var _getActiveOffer = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee15(listingId, address) {
      var offers;
      return runtime_1.wrap(function _callee15$(_context15) {
        while (1) {
          switch (_context15.prev = _context15.next) {
    ...
    function getActiveOffer(_x22, _x23) {
  ...
  _proto.getWinningBid = /*#__PURE__*/function () {
    var _getWinningBid = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee16(listingId) {
      var offers;
      return runtime_1.wrap(function _callee16$(_context16) {
        while (1) {
          switch (_context16.prev = _context16.next) {
  ...
  _proto.getBidBufferBps = /*#__PURE__*/function () {
    var _getBidBufferBps = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee17() {
      return runtime_1.wrap(function _callee17$(_context17) {
        while (1) {
          switch (_context17.prev = _context17.next) {
            case 0:
              return _context17.abrupt("return", this.readOnlyContract.bidBufferBps());
  ...
  _proto.getTimeBufferInSeconds = /*#__PURE__*/function () {
    var _getTimeBufferInSeconds = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee18() {
      return runtime_1.wrap(function _callee18$(_context18) {
        while (1) {
          switch (_context18.prev = _context18.next) {
            case 0:
  ...
  _proto.acceptDirectListingOffer = /*#__PURE__*/function () {
    var _acceptDirectListingOffer = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee19(listingId, addressOfOfferor) {
      return runtime_1.wrap(function _callee19$(_context19) {
        while (1) {
          switch (_context19.prev = _context19.next) {
            case 0:
    ...
    function acceptDirectListingOffer(_x25, _x26) {
  ...
  _proto.buyoutAuctionListing = /*#__PURE__*/function () {
    var _buyoutAuctionListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee20(listingId) {
      var listing;
      return runtime_1.wrap(function _callee20$(_context20) {
        while (1) {
          switch (_context20.prev = _context20.next) {
    ...
    function buyoutAuctionListing(_x27) {
  ...
  _proto.buyoutDirectListing = /*#__PURE__*/function () {
    var _buyoutDirectListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee21(_buyout) {
      var listing, quantity, value, overrides;
      return runtime_1.wrap(function _callee21$(_context21) {
        while (1) {
          switch (_context21.prev = _context21.next) {
            case 0:
    ...
    function buyoutDirectListing(_x28) {
  ...
  /*#__PURE__*/
  function () {
    var _updateDirectListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee22(listing) {
      return runtime_1.wrap(function _callee22$(_context22) {
        while (1) {
          switch (_context22.prev = _context22.next) {
            case 0:
    ...
    function updateDirectListing(_x29) {
  ...
  _proto.updateAuctionListing = /*#__PURE__*/function () {
    var _updateAuctionListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee23(listing) {
      return runtime_1.wrap(function _callee23$(_context23) {
        while (1) {
          switch (_context23.prev = _context23.next) {
            case 0:
    ...
    function updateAuctionListing(_x30) {
  ...
  _proto.cancelDirectListing = /*#__PURE__*/function () {
    var _cancelDirectListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee24(listingId) {
      var listing;
      return runtime_1.wrap(function _callee24$(_context24) {
        while (1) {
          switch (_context24.prev = _context24.next) {
    ...
    function cancelDirectListing(_x31) {
  ...
  _proto.cancelAuctionListing = /*#__PURE__*/function () {
    var _cancelAuctionListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee25(listingId) {
      var listing, now, startTime;
      return runtime_1.wrap(function _callee25$(_context25) {
        while (1) {
          switch (_context25.prev = _context25.next) {
            case 0:
            ...
            case 7:
              _context25.t0 = this;
              _context25.t1 = BigNumber.from(listingId);
              _context25.next = 11;
              return this.getSignerAddress();
            ...
            case 11:
              ...
              _context25.next = 15;
              return _context25.t0.sendTransaction.call(_context25.t0, "closeAuction", _context25.t3);
    ...
    function cancelAuctionListing(_x32) {
  ...
  _proto.closeAuctionListing = /*#__PURE__*/function () {
    var _closeAuctionListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee26(listingId, closeFor) {
      var listing;
      return runtime_1.wrap(function _callee26$(_context26) {
        while (1) {
          switch (_context26.prev = _context26.next) {
            ...
            case 12:
              ...
              if (!_context26.t0.message.includes("cannot close auction before it has ended")) {
                _context26.next = 18;
                break;
              }
    ...
    function closeAuctionListing(_x33, _x34) {
  ...
  _proto.setBidBufferBps = /*#__PURE__*/function () {
    var _setBidBufferBps = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee27(buffer) {
      var timeBuffer;
      return runtime_1.wrap(function _callee27$(_context27) {
        while (1) {
          switch (_context27.prev = _context27.next) {
  ...
  _proto.setTimeBufferInSeconds = /*#__PURE__*/function () {
    var _setTimeBufferInSeconds = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee28(buffer) {
      var bidBuffer;
      return runtime_1.wrap(function _callee28$(_context28) {
        while (1) {
          switch (_context28.prev = _context28.next) {
    ...
    function setTimeBufferInSeconds(_x36) {
  ...
  _proto.buyoutListing = /*#__PURE__*/function () {
    var _buyoutListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee29(listingId, quantityDesired) {
      var listing;
      return runtime_1.wrap(function _callee29$(_context29) {
        while (1) {
          switch (_context29.prev = _context29.next) {
            ...
            case 5:
              _context29.t0 = listing.listingType;
              _context29.next = _context29.t0 === ListingType.Direct ? 8 : _context29.t0 === ListingType.Auction ? 12 : 15;
              break;
    ...
    function buyoutListing(_x37, _x38) {
  ...
  _proto.getListing = /*#__PURE__*/function () {
    var _getListing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee30(listingId) {
      var listing;
      return runtime_1.wrap(function _callee30$(_context30) {
        while (1) {
          switch (_context30.prev = _context30.next) {
            ...
            case 5:
              _context30.t0 = listing.listingType;
              _context30.next = _context30.t0 === ListingType.Auction ? 8 : _context30.t0 === ListingType.Direct ? 11 : 14;
              break;
  ...
  _proto.getAllListings = /*#__PURE__*/function () {
    var _getAllListings = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee31() {
      var _this = this;
      ...
      return runtime_1.wrap(function _callee31$(_context31) {
        while (1) {
          switch (_context31.prev = _context31.next) {
            ...
            case 5:
              _context31.t3 = _context31.sent.toNumber();
              _context31.t4 = (0, _context31.t2)(_context31.t3).keys();
              _context31.t5 = _context31.t1.from.call(_context31.t1, _context31.t4).map(function (i) {
                return _this.getListing(i);
              });
              _context31.next = 10;
              return _context31.t0.all.call(_context31.t0, _context31.t5);
...
MarketplaceModule.roles = [RolesMap.admin, RolesMap.lister, RolesMap.pauser];
...
var NFTModule = /*#__PURE__*/function (_ModuleWithRoles) {
  ...
  _proto._v1MintBatchTo = /*#__PURE__*/function () {
    var _v1MintBatchTo2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee18(to, metadatas) {
      ...
      var baseUri, uris, receipt, events, tokenIds;
      return runtime_1.wrap(function _callee18$(_context18) {
        while (1) {
          switch (_context18.prev = _context18.next) {
            case 0:
  ...
  _proto.mintBatchTo = /*#__PURE__*/function () {
    var _mintBatchTo = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee19(to, metadatas) {
      ...
      var baseUri, uris, multicall, receipt, events, tokenIds;
      return runtime_1.wrap(function _callee19$(_context19) {
        while (1) {
          switch (_context19.prev = _context19.next) {
            case 0:
            ...
            case 13:
              ...
              _context19.next = 16;
              return this.parseLogs("TokenMinted", receipt.logs);
  ...
  _proto.generateSignatureBatch = /*#__PURE__*/function () {
    var _generateSignatureBatch = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee31(payloads) {
      ...
      var resolveId, cid, chainId, from, signer;
      return runtime_1.wrap(function _callee31$(_context31) {
        while (1) {
          switch (_context31.prev = _context31.next) {
            case 0:
...
var IpfsStorage = /*#__PURE__*/function () {
      ...
      return runtime_1.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 16:
              return _context3.abrupt("return", body.IpfsHash);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 13:
              ...
              throw new FetchError("Failed to fetch IPFS file: " + uri, _context5.t0);
  ...
  _proto.uploadFileHandler = /*#__PURE__*/function () {
    var _uploadFileHandler = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee6(object) {
      var keys, key, val, shouldUpload;
      return runtime_1.wrap(function _callee6$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              keys = Object.keys(object);
              _context6.t0 = runtime_1.keys(keys);
            ...
            case 9:
              object[keys[key]] = _context6.sent;
    ...
    function uploadFileHandler(_x12) {
  ...
  _proto.buildFilePropertiesMap =
  /*#__PURE__*/
  function () {
    var _buildFilePropertiesMap = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee7(object, files) {
      var keys, key, val, shouldUpload;
      return runtime_1.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 2:
              ...
              _context7.next = 10;
              return this.buildFilePropertiesMap(val, files);
    ...
    function buildFilePropertiesMap(_x13, _x14) {
      return _buildFilePropertiesMap.apply(this, arguments);
    }

    return buildFilePropertiesMap;
  }()
  /**
  ...
  /*#__PURE__*/
  function () {
    var _batchUploadProperties = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee8(metadata) {
      var filesToUpload, cid, cids, index, finalMetadata;
      return runtime_1.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              _context8.next = 2;
              return this.buildFilePropertiesMap(metadata, []);

            case 2:
              filesToUpload = _context8.sent;
            ...
            case 5:
              _context8.next = 7;
              return this.uploadBatchWithCid(filesToUpload, "");
            ...
            case 7:
              ...
              _context8.next = 12;
              return this.replaceFilePropertiesWithHashes(metadata, cids);

            case 12:
              finalMetadata = _context8.sent;
              return _context8.abrupt("return", finalMetadata);
    ...
    function batchUploadProperties(_x15) {
  ...
  /*#__PURE__*/
  function () {
    var _replaceFilePropertiesWithHashes = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee9(object, cids) {
      ...
      return runtime_1.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              keys = Object.keys(object).sort();
              _context9.t0 = runtime_1.keys(keys);
    ...
    function replaceFilePropertiesWithHashes(_x16, _x17) {
  ...
  _proto.uploadMetadata = /*#__PURE__*/function () {
    var _uploadMetadata = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee10(metadata, contractAddress, signerAddress) {
      return runtime_1.wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
    ...
    function uploadMetadata(_x18, _x19, _x20) {
      return _uploadMetadata.apply(this, arguments);
    }
  ...
  /*#__PURE__*/
  function () {
    var _uploadMetadataBatch = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee11(metadatas, contractAddress, startFileNumber) {
      var finalMetadata;
      return runtime_1.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              _context11.next = 2;
              return this.batchUploadProperties(metadatas);

            case 2:
              finalMetadata = _context11.sent;
              _context11.next = 5;
    ...
    function uploadMetadataBatch(_x21, _x22, _x23) {
...
var ThirdwebSDK = /*#__PURE__*/function () {
  ...
  _proto.defaultRelayerSendFunction = /*#__PURE__*/function () {
    ...
    function defaultRelayerSendFunction(_x6, _x7) {
